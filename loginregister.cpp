...
void loginregister::region(const QPoint &currentGlobalPoint)
{
...
//三个鼠标事件的重写
//鼠标按下事件
void loginregister::mousePressEvent(QMouseEvent *event)
{
    switch(event->button())
    {
    case Qt::LeftButton:
    ...
    case Qt::RightButton:
        ...
        break;
    default:
        loginregister::mousePressEvent(event);
    }
}
//鼠标移动事件
void loginregister::mouseMoveEvent(QMouseEvent *event)
{
...
//鼠标释放事件
void loginregister::mouseReleaseEvent(QMouseEvent *event)
{
...
void loginregister::on_pushButton_4_clicked()
{
    ui->~loginregister();
}


void loginregister::on_pushButton_3_pressed()
{

}


void loginregister::on_pushButton_3_clicked()
{
    MainWindow w;
    w.show();
}
